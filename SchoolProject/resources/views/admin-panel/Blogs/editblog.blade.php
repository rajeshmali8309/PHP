...
<body>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="{{ route('admin-blogs')}}" class="active"><i class="fa-solid fa-blog"></i> Blogs</a></li>
    ...
    <div class="content">
      <div class="header">
        ...
        <div class="table-container">            
            ...
            <form action="{{ route('editblog-store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <h2 class="frm">Edit Blog</h2>

                <input type="hidden" name="id" value="{{ $profileID->id }}">
                
                <label for="title">Title:</label>
                <input type="text" name="title" value="{{ $profileID->title }}" placeholder="Enter Title Name" id="title">
                 @error('title')
                   <div class="error">{{ $message }}</div>
                 @enderror<br><br>

                <label for="title">Description:</label>
                <input type="text" name="description" value="{{ $profileID->description }}" placeholder="Add Description" id="description">
                @error('description')
                   <div class="error">{{ $message }}</div>
                 @enderror<br><br>
