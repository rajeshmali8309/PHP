...
<body>
    ...
    <div class="content">
        ...
        <div class="table-container">
            ...
            <span onclick="toggleForm('login-form')">Add Gallery</span>
        </div>

        <div class="add-heading">
            <h3>GALLERIES DETAILS</h3>
        </div>
        ...
        <tbody>
            <tr>
                ...
                <td colspan="2" class="actions">
                    <a href="{{ route('edit-gallery', $value->id) }}" class="edit">Edit</a>
                    <a href="{{ route('delete-gallery', $value->id) }}" class="delete">Delete</a>
                </td>
            </tr>
...
<div class="form-container" id="login-form">
    ...
    <form action="{{ route('gallery-insert') }}" method="post" enctype="multipart/form-data">
        @csrf
        <h2 class="frm">Add Gallery</h2>
        <label>Select Gallery </label>
        <input type="file" name="profile" id="login-email" required>
