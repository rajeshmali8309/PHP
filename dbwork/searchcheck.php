...
while ($row = mysqli_fetch_assoc($result)) {
	          ...
	          if($search==$row['id'] || $search==$row['name'] ||$search==$row['email'] || $search==$row['number'] || $search==$row['gender'] || $search==$row['DOB'] || $search==$row['hobbies'] ||$search==$row['time'] || $search==$row['volume'] ||$search==$row['qualification'])
	             {
